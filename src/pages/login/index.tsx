...
const Home: NextPage = () => {
  ...
  const handleSubmit: FormEventHandler<HTMLFormElement> = async (e) => {
    e.preventDefault();
    const response = await signIn("domain", {
      ...
      <main className="grid min-h-screen place-items-center bg-gradient-to-br from-slate-900 to-slate-800 text-slate-400">
        ...
        >
          <span className="mb-6 px-16 text-center text-2xl font-bold">
            <span className="inline-block whitespace-pre">Sign in </span>
            <span className="inline-block whitespace-pre">to your account</span>
          </span>
          <label className="my-2 dark:text-gray-300">
            <span className="block py-1">Your email</span>
            <input
          ...
          <Link
            className="my-2 ml-auto font-semibold text-blue-500 transition-colors duration-300 ease-in-out hover:text-blue-600 hover:underline"
            href={"/register"}
          >
